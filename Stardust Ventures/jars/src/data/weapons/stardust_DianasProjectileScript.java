...
public class stardust_DianasProjectileScript extends BaseEveryFrameCombatPlugin {
     ...
     */
    public stardust_DianasProjectileScript(@NotNull DamagingProjectileAPI proj, CombatEntityAPI target) {
        this.proj = proj;
        this.target = target;
